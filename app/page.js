...
if(mainTask.length>0){
  ...
  return (
    <>
    <h1 className='bg-black text-white p-5 text-5xl font-bold text-center' >Surya's Todolist</h1>
    <form onSubmit={submitHandler}>
      ...
      />
      <button className='bg-black text-white m-5 px-4 py-3 text-2xl ront-bold rounded'>Add Task</button>
    </form>
    <hr />
